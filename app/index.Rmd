...
# load data
org_subscription_events <- read_csv("data/org subscription events.csv")
product_usage <- read_csv("data/product usage.csv")
new_data <- readRDS("data/new_data.rds")
corrr_analysis <- readRDS("data/corrr_analysis.rds")

# load model
super_model <- readRDS("models/fit_glm.rds")
